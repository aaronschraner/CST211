...
#include "iterators/InOrder_impl.h"
...
/********************************************************************************
 * void Traverse (TreeFunc tf, TraversalPath path, void* parameter);
 * 	Purpose: 
 ...
 *
 * 		tf gets passed <parameter> on execution
 * 	
 * 	Entry: 
 ...
 ********************************************************************************/
template < typename T >
void BinaryTree<T>::Traverse (TreeFunc tf, TraversalPath path, void* parameter)
{
	if(!root)
		return;
	switch(path)
	{
		case BinaryTree::_InOrder: root->InOrderTraverse(tf, parameter); break;
		case BinaryTree::_PreOrder: root->PreOrderTraverse(tf, parameter); break;
		case BinaryTree::_PostOrder: root->PostOrderTraverse(tf, parameter); break;
		case BinaryTree::_BreadthFirst: root->BreadthFirstTraverse(tf, parameter); break;
	}
...
template <typename T>
TreeIterator<T> BinaryTree<T>::getIterator(TraversalPath path)
{
	switch(path)
	{

		case BinaryTree::_InOrder:      return InOrderIterator<T>(this);
		//case BinaryTree::_PreOrder:     return PreOrderIterator<T>(this);
		//case BinaryTree::_PostOrder:    return PostOrderIterator<T>(this);
		//case BinaryTree::_BreadthFirst: return PostOrderIterator<T>(this);
	}
}
#endif
